 ...
 */
@MessageDriven(name = "PdfInvoiceGenerationJobConsumer", activationConfig = {
		@ActivationConfigProperty(propertyName = "destinationLookup", propertyValue = "queue/PDFINVOICEGENERATIONJOBQUEUE"),
		@ActivationConfigProperty(propertyName = "destinationType", propertyValue = "javax.jms.Queue"),
		@ActivationConfigProperty(propertyName = "acknowledgeMode", propertyValue = "Auto-acknowledge") })
public class PdfInvoiceGenerationJobConsumer extends BaseJobQueueConsumer implements MessageListener {
	...
	protected void processMessage(ClusterJobQueueDto message) {
		try {
			...
			if (message.getItems() != null) {
				invoicingAsync.generatePdfAsync(
