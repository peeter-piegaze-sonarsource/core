...
@Path("/knowledgecenter/content")
@Consumes({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML })
@Produces({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML })
public interface ContentRs extends IBaseRs{
	@POST
    @Path("/")
    ActionStatus create(ContentDto contentData);

	@PUT
    @Path("/")
    ActionStatus update(ContentDto contentData);
	
	@POST
    @Path("/createOrUpdate")
    ActionStatus createOrUpdate(ContentDto contentData);
	
	@GET
    @Path("/")
    GetContentResponseDto find(@QueryParam("id") Long id);
    ...
    @GET
    @Path("/list")
    public ContentsResponseDto listGet(@QueryParam("query") String query, @QueryParam("fields") String fields, @QueryParam("offset") Integer offset,
